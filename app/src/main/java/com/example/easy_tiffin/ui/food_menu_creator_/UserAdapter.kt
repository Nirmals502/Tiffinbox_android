            ...
            popupMenus.setOnMenuItemClickListener {
                when (it.itemId) {
                    R.id.editText -> {
                        ...
                        val name = v.findViewById<AutoCompleteTextView>(R.id.itemNameAutoComplete)
                        val number = v.findViewById<EditText>(R.id.userNo)
                        val editText_item: AutoCompleteTextView =
                            v.findViewById(R.id.itemNameAutoComplete) // Assuming R.id.userName is the ID of your EditText
